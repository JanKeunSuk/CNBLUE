...
sp0=Sprint.objects.create(descripcion='sprint0',fecha_inicio=str(datetime.date.today()-timedelta(days=15)),duracion=7,estado='FIN',proyecto=p1)
#este va a ser el que tenga hus pendientes las cuales tengo que crear nuevas
sp01=Sprint.objects.create(descripcion='sprint01',fecha_inicio=str(datetime.date.today()+timedelta(days=-7)),duracion=6,estado='FIN',proyecto=p1)
