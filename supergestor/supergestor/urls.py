...
urlpatterns = patterns('',
    ...
    url(r'^visualizarRol/(?P<proyectoid>\d+)/(?P<rol_id_rec>\d+)/$', views.visualizarRolProyectoView, name='visualizar_rol'),
    url(r'^crearRol/(?P<usuario_id>\d+)/', views.crearRol, name='crear_Rol'),
    url(r'^guardarRol/(?P<usuario_id>\d+)/', views.guardarRolView, name='guardar_nuevo_rol'),
    url(r'^visualizarFlujo/(?P<proyectoid>\d+)/(?P<flujo_id_rec>\d+)/$', views.visualizarFlujoProyectoView, name='visualizar_flujo'),
    url(r'^modificarFlujo/(?P<proyectoid>\d+)/(?P<flujo_id_rec>\d+)/$', views.modificarFlujo, name='modificar_flujo'),
    url(r'^crearFlujo/', views.crearFlujo, name='crear_Flujo'),
